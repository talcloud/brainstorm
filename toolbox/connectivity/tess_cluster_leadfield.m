function [Labels,err] = tess_cluster_leadfield(sSurf, ImagingKernel, Leadfield, Atlas)
% TESS_CLUSTER_LEADFIELD: Maximum resolution map correlation clustering
%
% USAGE:  Labels = tess_cluster_leadfield(Surface, Results.ImagingKernel, HeadModel.Gain(Results.GoodChannel,:))
%
% INPUTS: 
