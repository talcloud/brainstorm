function [ChannelMat, R, T, isSkip] = channel_align_auto(ChannelFile, ChannelMat, isWarning, isConfirm)
% CHANNEL_ALIGN_AUTO: Aligns the channels to the scalp using Polhemus points.
%
% USAGE:  [ChannelMat, R, T, isSkip] = channel_align_auto(ChannelFile, ChannelMat=[], isWarning=1, isConfirm=1)
%
% DESCRIPTION: 
...
%   isSkip    : Processing was skipped because there was not enough information in the file
