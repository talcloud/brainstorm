function [HeadFile, iSurface] = tess_isohead(iSubject, nVertices, erodeFactor, fillFactor)
% TESS_GENERATE: Reconstruct a head surface based on the MRI, based on an isosurface
%
% USAGE:  [HeadFile, iSurface] = tess_isohead(iSubject, erodeFactor=2, nVertices=10000, fillFactor=2)
%         [HeadFile, iSurface] = tess_isohead(MriFile,  erodeFactor=2, nVertices=10000, fillFactor=2)
