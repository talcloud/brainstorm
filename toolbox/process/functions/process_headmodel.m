...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.options.label1.Comment = 'Source space:';
    ...
    sProcess.options.label2.Comment = '<BR>Forward modeling methods:';
    ...
    sProcess.options.label3.Comment = '<BR>Methods options:';
