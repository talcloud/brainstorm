function varargout = process_select_files_matrix( varargin )
% PROCESS_SELECT_FILES_MATRIX: Select files from the database, based on the subject name and the condition.
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Select files: Matrix';
    sProcess.FileTag     = '';
...
function Comment = FormatComment(sProcess) %#ok<DEFNU>
    % Define file type
    sProcess.options.filetype.Value = 'matrix';
    % Call common process
