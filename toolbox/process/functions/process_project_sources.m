...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Index       = 334;
    sProcess.Description = 'http://neuroimage.usc.edu/brainstorm/Tutorials/CoregisterSubjects';
...
%     sProcess.options.source_abs.Comment = 'Use absolute values of source activations<BR><I>This directive works only for full results: [nSources x nTime]</I>';
