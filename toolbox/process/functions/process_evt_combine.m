...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Index       = 53;
    sProcess.Description = 'http://neuroimage.usc.edu/brainstorm/Tutorials/EventMarkers?highlight=%28Combine+stim%2Fresponse%29#Events';
    ...
    sProcess.options.combine.Comment = ['Example: We have one stim (A) and two responses (B and C).<BR>' ...
                                        ...
                                        '&nbsp;&nbsp;&nbsp;&nbsp;<B>C_AC</B>: Event C (preceded by C)<BR>' ...
