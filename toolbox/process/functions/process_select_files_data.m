...
%        FileNames = process_select_files_data('SelectFiles', ConditionPath, FileType)
...
function OutputFiles = Run(sProcess, sInputs) %#ok<DEFNU>
    ...
    % Get files
    OutputFiles = SelectFiles([SubjectName '/' Condition], FileType, IncludeBad, IncludeIntra, IncludeCommon);
...
%% ===== SELECT FILES =====
function FileNames = SelectFiles(ConditionPath, FileType, IncludeBad, IncludeIntra, IncludeCommon)
    FileNames = {};
    % Parse inputs
    ...
    switch lower(FileType)
                    ...
                    for iTf = 1:length(sStudies(i).Timefreq)
                        ...
                        if ~isempty(DataFile)
                            ...
                            if isempty(iData)
                                ...
                                if sStudy_tmp.Data(iData).BadTrial
        ...
        otherwise,       process_select_files_data
