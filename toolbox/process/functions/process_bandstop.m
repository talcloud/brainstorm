...
%                    x = process_bandstop('Compute', x, sfreq, FreqList, FreqWidth, method=[])
...
%     end
    ...
    sInput.FileTag = [sProcess.FileTag '(' strValue(1:end-1) ')'];
    % Comment for History
...
%% ===== EXTERNAL CALL =====
% USAGE: x = process_bandstop('Compute', x, sfreq, FreqList, FreqWidth=1, method='fieldtrip_butter')
