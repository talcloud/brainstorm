...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Index       = 67;
    sProcess.Description = 'http://neuroimage.usc.edu/brainstorm/Tutorials/ArtifactsFilter#Alternatives_to_the_notch';
    ...
    % === Warning
    sProcess.options.warning.Comment = '<U>Warning</U>: This method has shown to have stability issues.<BR><BR>&nbsp;Please consider using the following filters instead:<BR>&nbsp;&nbsp;&nbsp;- <B>Notch filter</B>: for very well identified 50/60Hz peaks (+harmonics)<BR>&nbsp;&nbsp;&nbsp;- <B>Band-stop filter</B>: for artifacts that spread over larger frequency bands.<BR><BR>';
