...
function PlotHandles = PlotAxes(iDS, hAxes, PlotHandles, TimeVector, F, TsInfo, LinesLabels, LinesColor, isFastUpdate, Std)
    ...
    switch (lower(TsInfo.DisplayMode))
        case 'butterfly'
            PlotHandles = PlotAxesButterfly(iDS, hAxes, PlotHandles, TsInfo, TimeVector, F, LinesLabels, isFastUpdate, Std);
        case 'column'
...
%% ===== PLOT AXES BUTTERFLY =====
function PlotHandles = PlotAxesButterfly(iDS, hAxes, PlotHandles, TsInfo, TimeVector, F, LinesLabels, isFastUpdate, Std)
    global GlobalData;
    ZData = 1.5;
...
function PlotHandles = PlotAxesColumn(hAxes, PlotHandles, TsInfo, TimeVector, F, LinesLabels, isFastUpdate, Std)
    ...
    if ~isempty(LinesLabels)
        ...
        set(hAxes, 'YTickMode',      'manual', ...
                   ...
                   'YTick',          bst_flip(PlotHandles.ChannelOffsets, 1), ...
