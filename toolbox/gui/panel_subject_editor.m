...
function bstPanelNew = CreatePanel() %#ok<DEFNU>
    ...
    jPanelDefaults = gui_river('Defaults');
        ...
        jRadioChannelIndividual     = JRadioButton('No, use one channel file per acquisition run (MEG).');
        jRadioChannelDefaultSubject = JRadioButton('Yes, use one channel file per subject (EEG).');
