...
%% ===== LOAD OPTIONS =====
    function LoadOptions()
        ...
        % Processing options for continuous raw files
        % ProcessOptions = bst_get('ProcessOptions');
        % jCheckOrigFolder.setSelected(ProcessOptions.UseOrigFolder);
        % jCheckOrigFormat.setEnabled(ProcessOptions.UseOrigFolder);
        % jCheckOrigFormat.setSelected(ProcessOptions.UseOrigFolder && ProcessOptions.UseOrigFormat);
    end
...
%         % Processing options for continuous raw files
%         ProcessOptions = bst_get('ProcessOptions');
%         ProcessOptions.UseOrigFolder = jCheckOrigFolder.isSelected();
%         ProcessOptions.UseOrigFormat = ProcessOptions.UseOrigFolder && jCheckOrigFormat.isSelected();
