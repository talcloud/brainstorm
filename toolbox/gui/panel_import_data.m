...
% %% ===== UPDATE CREATE CONDITIONS =====
%     function UpdateDefaultCreateCond(varargin)
%         if isEpochs
%             jCheckCreateCond.setEnabled(1);
%             if ~ismember(sFile.format, {'CTF','LENA','EEG-NEUROSCAN-EEG'}) || (isEvents && jCheckUseEvents.isSelected())
%                 jCheckCreateCond.setSelected(1);
%             else
%                 jCheckCreateCond.setSelected(0);
%             end
%         else
%             if isEvents
% %                 jCheckCreateCond.setEnabled(1);
