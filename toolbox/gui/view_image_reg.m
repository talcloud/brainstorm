function [hFig, iDS, iFig] = view_image_reg(Data, Labels, iDims, DimLabels, FileName, hFig, ColormapType, ShowLabels, PageName)
% VIEW_IMAGE_REG: Display an image, with possible variations in time and frequencies.
%
% USAGE: [hFig, iDS, iFig] = view_image_reg(Data, Labels=[], iDims=[1,2], DimLabels=[], FileName=[], hFig=[], ColormapType='image', ShowLabels=0, PageName=[first])
%
% INPUT: 
