function [hFig, iDS, iFig] = view_erpimage( DataFiles, Modality, DisplayMode, hFig )
...
switch lower(DisplayMode)
    case 'trialimage'
        ...
        Labels{4} = [];        
        % Show the image
        [hFig, iDS, iFig] = view_image_reg(F, Labels, [1,3], {'Channels','Time (s)'}, DataFiles{1}, hFig, ColormapType, 1, PageName);
...
%         panel_freq('UpdatePanel');
        % Show the image
        [hFig, iDS, iFig] = view_image_reg(ERP, Labels, [1,3], {'Trials','Time (s)'}, DataFiles{1}, hFig, ColormapType, 1, []);
...
% Reload call
ReloadCall = {'view_erpimage', DataFiles, Modality, DisplayMode, hFig};
