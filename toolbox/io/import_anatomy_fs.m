...
TessInnerFile = file_find(FsDir, 'inner_skull-*.surf');
TessOuterFile = file_find(FsDir, 'outer_skull-*.surf');
...
% Find labels
AnnotLhFiles = {file_find(FsDir, 'lh.pRF.annot'), file_find(FsDir, 'lh.aparc.a2009s.annot'), file_find(FsDir, 'lh.aparc.annot'), file_find(FsDir, 'lh.BA.annot'), file_find(FsDir, 'lh.BA.thresh.annot'), file_find(FsDir, 'lh.aparc.DKTatlas40.annot'), ...
...
AnnotRhFiles = {file_find(FsDir, 'rh.pRF.annot'), file_find(FsDir, 'rh.aparc.a2009s.annot'), file_find(FsDir, 'rh.aparc.annot'), file_find(FsDir, 'rh.BA.annot'), file_find(FsDir, 'rh.BA.thresh.annot'), file_find(FsDir, 'rh.aparc.DKTatlas40.annot'), ...
...
if isComputeMni
    ...
    [sMri, errCall] = bst_normalize_mni(iSubject);
    % Error handling
