function [nev] = neuralynx_read_nev(filename, varargin)
% READ_NEURALYNX_NEV reads the event information from the *.nev file in a Neuralynx dataset directory
% Use as
...
% 19-Jun-2015 Edited by Francois Tadel for the integration in Brainstorm
