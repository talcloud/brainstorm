...
% IN_HEADMODEL_BST: Read a headmodel file in Brainstorm format.
% 
% USAGE:  HeadModel = in_headmodel_bst(HeadModelFile, ApplyOrient, FieldsList) : Read the specified fields
%         HeadModel = in_headmodel_bst(HeadModelFile, ApplyOrient)             : Read all the fields
%         HeadModel = in_headmodel_bst(HeadModelFile)                          : Read all the fields and do NOT constrain orientations
% 
% INPUT:
