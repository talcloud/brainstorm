...
isRaw = ismember(FileFormat, {'FIF', 'CTF', 'CTF-CONTINUOUS', '4D', 'KIT', 'KDF', 'ITAB', 'LENA', 'EEG-ANT-CNT', 'EEG-BRAINAMP', 'EEG-DELTAMED', 'EEG-COMPUMEDICS-PFS', 'EEG-EGI-RAW', 'EEG-NEUROSCAN-CNT', 'EEG-NEUROSCAN-EEG', 'EEG-NEUROSCAN-AVG', 'EEG-EDF', 'EEG-BDF', 'EEG-EEGLAB', 'EEG-GTEC', 'EEG-MANSCAN', 'EEG-NEURALYNX', 'EEG-BLACKROCK', 'EEG-NEURONE', 'EEG-NEUROSCOPE', 'NIRS-BRS', 'BST-DATA', 'BST-BIN', 'EYELINK'});
