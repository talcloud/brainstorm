...
% ===== NUMBER OF USERS =====
% Read list of users
str = url_read_fcn('http://neuroimage.usc.edu/brainstorm3_register/get_userdate.php?c=k9w8cX');
% Extract values
...
% ===== LOG ANALYSIS =====
% Read list of users
str = url_read_fcn('http://neuroimage.usc.edu/brainstorm3_register/get_logs.php?c=J7rTwq');
% Extract values
...
% Read list of users
str = url_read_fcn('http://neuroimage.usc.edu/brainstorm3_register/get_posts.php?c=3Emzpjt0');
% Extract values
dates = textscan(str, '%d %d');
dates = double([dates{1}, dates{2}]);
dates = dates(:,1) + (dates(:,2)-1)./12;
...
nPubli = [   2    2    1    1    3    5    5   11   10   18   19   33   38   54   78   92];
nPubliCurYear = 8;
% Plot figure
