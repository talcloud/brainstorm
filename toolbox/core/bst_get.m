...
%    - bst_get('DipolesForFile',    FileName, iStudies)   : Find all timefreq files computed based on target file
        ...
        switch lower(varargin{2})
            ...
            case 'surface'
                argout1 = {...
                    ...
                    {'.tri'},   'TRI (*.tri)',             'TRI'; ...
                    {'.mri', '.fif', '.img', '.ima', '.nii', '.mgh', '.mgz', '.mnc', '.mni', '.gz', '_subjectimage'}, 'Volume mask or atlas (all MRI files)', 'MRI-MASK'; ...
...
%                     };
            ...
            case 'events'
                argout1 = {...
                    ...
                    {'.event','.ptx'}, 'LENA (*.ptx;*.event)',          'LENA'; ...
                    {'.eve','.fif'},   'Neuromag MNE (*.eve;*.fif)',    'FIF'; ...
                    {'.evl','.txt'},   'Neuromag Graph (*.evl;*.txt)',  'GRAPH'; ...
            ...
            case 'channel'
                argout1 = {...
                    ...
                    {'.res','.rs3'},               'EEG: Curry (*.res;*.rs3)',            'CURRY'; ...
