function bst_deploy_java_2015a(IS_BIN)
% BST_DEPLOY_JAVA - Brainstorm deployment script.
%
% USAGE:  bst_deploy_java_2015a(IS_BIN=0)
%
% INPUTS:
...
if IS_BIN
    ...
    % Javabuilder output
    compilerFile = fullfile(bstDir, 'deploy', 'bst_javabuilder_2015a.prj');
...
if IS_BIN
    ...
    % Compiled jar
    compiledJar = fullfile(compilerOutputDir, 'bst_javabuilder_2015a.jar');
    ...
    fwrite(fid, ['Manifest-Version: 1.0' 13 10 ...
                 'Main-Class: bst_javabuilder_2015a.Run' 13 10 ...
    ...
    classFile = fullfile('org', 'brainstorm', 'file', 'SelectMcr2015a.class');
    ...
    system(['cd "' jarDir '" & "' jdkDir '\bin\jar.exe" cmf manifest.txt "' bstJar '" bst_javabuilder_2015a org com']);
end
