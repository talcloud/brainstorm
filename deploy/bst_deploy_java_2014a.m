function bst_deploy_java_2014a(IS_BIN)
% BST_DEPLOY_JAVA - Brainstorm deployment script.
%
% USAGE:  bst_deploy_java_2014a(IS_BIN=0)
%
% INPUTS:
...
if IS_BIN
    ...
    ReleaseName = bst_get('MatlabReleaseName');
    % Javabuilder output
    compilerFile = fullfile(bstDir, 'deploy', 'bst_javabuilder_2014a.prj');
...
if IS_BIN
    ...
    classFile = fullfile('org', 'brainstorm', 'file', 'SelectMcr2014a.class');
