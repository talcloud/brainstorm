function bst_deploy_java_2014b(IS_BIN)
% BST_DEPLOY_JAVA - Brainstorm deployment script.
%
% USAGE:  bst_deploy_java_2014b(IS_BIN=0)
%
% INPUTS:
...
if IS_BIN
    ...
    % Javabuilder output
    compilerFile = fullfile(bstDir, 'deploy', 'bst_javabuilder_2014b.prj');
...
if IS_BIN
    ...
    % Compiled jar
    compiledJar = fullfile(compilerOutputDir, 'bst_javabuilder_2014b.jar');
    ...
    fwrite(fid, ['Manifest-Version: 1.0' 13 10 ...
                 'Main-Class: bst_javabuilder_2014b.Run' 13 10 ...
    ...
    classFile = fullfile('org', 'brainstorm', 'file', 'SelectMcr2014b.class');
    ...
    system(['cd "' jarDir '" & "' jdkDir '\bin\jar.exe" cmf manifest.txt "' bstJar '" bst_javabuilder_2014b org com']);
end
