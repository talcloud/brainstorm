function Header = fastReadLENAHead(lena_file,dim_to_read)
...
%  
% Usage :
%   H=fastReadLENAHead('/path/to/file/test.lena');
%       will return a matrix containing all data
%
%   H=fastReadLENAHead('/path/to/file/test.lena',{ 2 , [ ] , [5:12] });
...
if exist('frequency_dim')
    ...
    Header.frequencysamples= frequencysamples;%reshape(frequencysamples, 1,length(frequencysamples));
    %end
